...
namespace Dumper
{
    namespace OffsetManager
    {
        ...
        {
            if( !pProcess->GetModuleByName( "client_panorama.dll" ) || !pProcess->GetModuleByName( "engine.dll" ) )
                return;
            ...
            DumpPatternOffset( "DT_BaseCombatWeapon", "m_bCanReload", "client_panorama.dll",
                               "80 B9 ? ? ? ? ? 0F 85 ? ? ? ? A1",
            ...
            DumpPatternOffset( "DT_CSPlayerResource", "CSPlayerResource", "client_panorama.dll",
            ...
            DumpPatternOffset( "BaseEntity", "m_bDormant", "client_panorama.dll",
            ...
            DumpPatternOffset( "EngineRender", "m_dwViewMatrix", "client_panorama.dll",
            ...
            DumpPatternOffset( "RadarBase", "m_dwRadarBase", "client_panorama.dll",
                               "A1 ? ? ? ? 8B 0C B0 8B 01 FF 50 ? 46 3B 35 ? ? ? ? 7C EA 8B 0D",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x1, 0x0, ss );

            DumpNetVar( "RadarBase", "m_dwRadarBasePointer", 0x50, ss );

            DumpPatternOffset( "LocalPlayer", "m_dwLocalPlayer", "client_panorama.dll",
                               "A3 ? ? ? ? C7 05 ? ? ? ? ? ? ? ? E8 ? ? ? ? 59 C3 6A",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x1, 0x2C, ss );

            DumpPatternOffset( "EntityList", "m_dwEntityList", "client_panorama.dll",
                               "BB ? ? ? ? 83 FF 01 0F 8C ? ? ? ? 3B F8",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x1, 0x0, ss );

            DumpPatternOffset( "WeaponTable", "m_dwWeaponTable", "client_panorama.dll",
                               "A1 ? ? ? ? 0F B7 C9 03 C9 8B 44 ? 0C C3",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x1, 0x0, ss );

            DumpPatternOffset( "WeaponTable", "m_dwWeaponTableIndex", "client_panorama.dll",
                               "66 8B 8E ? ? ? ? E8 ? ? ? ? 05 ? ? ? ? 50",
                               Remote::SignatureType_t::READ, 0x3, 0x0, ss );

            DumpPatternOffset( "Extra", "m_dwInput", "client_panorama.dll",
            ...
            DumpPatternOffset( "Extra", "m_dwGlowObject", "client_panorama.dll",
                               "A1 ? ? ? ? A8 01 75 4E 0F 57 C0",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x58, 0x0, ss );

            DumpPatternOffset( "Extra", "m_dwForceJump", "client_panorama.dll",
                               "89 15 ? ? ? ? 8B 15 ? ? ? ? F6 C2 03 74 03 83 CE 08",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );

            DumpPatternOffset( "Extra", "m_dwForceAttack", "client_panorama.dll"
                               , "89 15 ? ? ? ? 8B 15 ? ? ? ? F6 C2 03 74 03 83 CE 04",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );
			
            DumpPatternOffset( "Extra", "m_dwForceAttack2", "client_panorama.dll"
                               , "89 15 ? ? ? ? 8B 15 ? ? ? ? F6 C2 03 74 06 81 CE ? 20 ? ? A9 ? 20 ? ? BF FD FF FF FF",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );

			DumpPatternOffset( "Extra", "m_dwForceForward", "client_panorama.dll"
                               , "8B 15 ? ? ? ? F6 C2 03 74 03 83 CE 08 A8 08 BF FD FF FF FF",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );
			
            DumpPatternOffset( "Extra", "m_dwForceBackward", "client_panorama.dll"
                               , "8B 15 ? ? ? ? F6 C2 03 74 03 83 CE 10 A8 10 BF FD FF FF FF",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );
			
            DumpPatternOffset( "Extra", "m_dwForceLeft", "client_panorama.dll"
                               , "89 15 ? ? ? ? 8B 15 ? ? ? ? F6 C2 03 74 06 81 CE ? 04 ? ? A9 ? 04 ? ? BF FD FF FF FF",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );

            DumpPatternOffset( "Extra", "m_dwForceRight", "client_panorama.dll"
                               , "89 15 ? ? ? ? 8B 15 ? ? ? ? F6 C2 03 74 06 81 CE ? 08 ? ? A9 ? 08 ? ? BF FD FF FF FF",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0x2, 0x0, ss );
							   
	    DumpPatternOffset( "Extra", "m_pSensitivity", "client_panorama.dll"
			      , "6A 01 51 C7 04 24 17 B7 D1 38 B9",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0xB, 0x0, ss );

            DumpPatternOffset( "Extra", "m_dwSensitivity", "client_panorama.dll"
			      , "6A 01 51 C7 04 24 17 B7 D1 38 B9",
                               Remote::SignatureType_t::READ | Remote::SignatureType_t::SUBTRACT, 0xB, 0x2C, ss );
		   

            DumpPatternOffset( "Extra", "m_dwMouseEnable", "client_panorama.dll",
