...
namespace Dumper
{
    namespace NetVarManager
    {
        ...
        {
            auto firstclass = pProcess->FindPattern( "client_panorama.dll", "44 54 5F 54 45 57 6F 72 ? 64 44 65 63 61 6C", 0, 0, 0 );
            ...
            firstclass = pProcess->FindPattern( "client_panorama.dll", ss.str().c_str(), Remote::SignatureType_t::READ, 0x2B, 0 );
